      ...
      <div>
        ...
        <div className="mt-20 max-w-xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <button
              className="inline-flex items-center justify-center gap-2 bg-white hover:bg-gray-50 text-[#171717] px-8 py-3.5 rounded-full font-medium border border-gray-200 transition-colors shadow-sm"
              onClick={() => {
                // Simulate google auth
                window.location.href = "/apply/basic-information";
              }}
            >
